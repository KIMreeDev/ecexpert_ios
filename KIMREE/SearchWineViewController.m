...
{
    static NSString *SampleIdentifier = @"SampleIdentifier";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:SampleIdentifier];

    
    if (cell==nil) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:SampleIdentifier];
...
//    NSLog(@"测试一下%@",displayVC.dealerItem.dealerName);
//    NSLog(@"(%@,%@)",displayVC.dealerItem.dealerLatitude,displayVC.dealerItem.dealerLongitude);
