...
{
    [_delegate didSelectedDealerItem:_dealerItem];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    if (indexPath.section==0) {
        ...
        }else if(indexPath.row==2)
        {
                ...
                cell.textLabel.text=[NSString stringWithFormat:NSLocalizedString(@"Phone:%@", ""),_dealerItem.dealerTel];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0&&indexPath.row==1) {
        ...
        [_delegate didSelectedDealerItem:_dealerItem];
        _dealerCoordinate=[NSArray arrayWithObjects:_dealerItem.dealerLatitude,_dealerItem.dealerLongitude,_dealerItem.dealerName,nil];
...
- (void)call {
    ...
    NSURL *phoneURL = [NSURL URLWithString:[NSString stringWithFormat:@"tel:%@",_dealerItem.dealerPhone]];
    if ( !phoneCallWebView ) {
